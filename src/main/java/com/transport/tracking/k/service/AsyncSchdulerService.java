...
//        }
        ...
        if (productVO.getQuantity() != null && productVO.getQuantity().length() > 4) {
            int dotIndex = productVO.getQuantity().indexOf(".");
            if (dotIndex > 0) {
                productVO.setQuantity(productVO.getQuantity().substring(0, dotIndex));
            } else {
